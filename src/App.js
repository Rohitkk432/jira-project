...
function App() {
    ...
    return (
        <div className="App">
            <NavBar grouping={grouping} grpOptions={grpOptions} orderOptions={orderOptions} ordering={ordering} setGrouping={setGrouping} setOrdering={setOrdering} />
            <div className="TicketContainer">
                {Object.keys(dataToShow).map((key) => {
                    return <TicketColumn data={dataToShow[key]} groupingData={groupingData} heading={key} />;
                })}
            </div>
        </div>
    );
